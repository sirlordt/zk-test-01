...
public class CController01 extends SelectorComposer<Component> {
    ...
    public void doAfterCompose(Component comp) throws Exception {
        ...
        customMenuPopup.setWidgetOverride("doKeyDown_",
                "function (evt) { this.$supers( 'doKeyDown_', arguments); }");
        ...
        menuNew.setWidgetOverride("doKeyDown_",
                "function (evt) { this.$supers( 'doKeyDown_', arguments); }");
        ...
        // zk.log('hello!');
        // menuNew.setWidgetOverride( "doClick_" ,
        // "function (evt) { if (this.menupopup) { if (this.isTopmost()) this.getMenubar()._lastTarget = this; _doClick(this, evt); } else { this._showContentHandler(); } evt.stop(); }"
        // );
    ...
    //
    // @Listen(
    // "onClick = #windowMenuTest01 #menuNew; onClick = #windowMenuTest01 #menuUndo; onClick = #windowMenuTest01 #menuCut; onClick = #windowMenuTest01 #menuCopy; onClick = #windowMenuTest01 #menuPaste"
    // )
