...
public class CustomMenu extends Menu {
    ...
    static {
        addClientEvent(CustomMenu.class, Events.ON_CLICK, CE_IMPORTANT
                | CE_DUPLICATE_IGNORE);
        addClientEvent(CustomMenu.class, Events.ON_CHANGE, CE_IMPORTANT
                | CE_DUPLICATE_IGNORE);
    }
     ...
     * 
     * <p>
     * There is a way to create Colorbox automatically by using #color=#RRGGBB,
     * usage example <code>setContent("#color=#FFFFFF")</code>
     *
     * @since 5.0.0
     */
     ...
     * <p>
     * Note that this function is only applied when it is topmost menu, i.e. the
     * parent of the menu is {@link Menubar}
     * 
     * @since 6.0.0
     */
    public void open() {
    ...
    public void beforeChildAdded(Component child, Component refChild) {
        /*
         * if (child instanceof Menupopup) { if (_popup != null && _popup !=
         * child) throw new UiException("Only one menupopup is allowed: " +
         * this); } else { throw new UiException("Unsupported child for menu: "
         * + child); } super.beforeChildAdded(child, refChild);
         */
    }
     ...
     *
     * <p>
     * Default: in addition to what are handled by
     * {@link LabelImageElement#service}, it also handles onClick.
     * 
     * @since 5.0.0
     */
